...
map<anabin, syst> readSyst_all(const char* collSystem="", const char* poiname="NJpsi", const char* nameTag="16025", bool readEffSyst=false, const char* prependPath="", bool doPrintTex=false, const char* texName="Systematics/systs.tex");
